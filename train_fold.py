...
def main(args, dict_config, config_file_path):
    ...
    logging.info(f'number of test_fold steps per epoch: {len(dataloaders_dict["test_fold"])}')
    ...
    start_time = time()
    test_loss, test_acc, test_macro_f1, test_f1 = valid(0, accelerator, dataloaders_dict["test_family"],
