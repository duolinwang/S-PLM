...
from data import prepare_dataloaders_enzyme_reaction
...
def main(args, dict_config, config_file_path):
    ...
    dataloaders_dict = prepare_dataloaders_enzyme_reaction(configs)
    ...
    start_time = time()
    test_loss, test_acc, test_macro_f1, test_f1 = valid(0, accelerator, dataloaders_dict["test"],
