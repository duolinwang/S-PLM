'''
Revise the FOLD code for EC purpose
Qing Shao Dec-7-2023
'''
print("start the codes")
import os
import numpy as np
import yaml
import argparse
...
from data import prepare_dataloaders_go
print("start the codes4")
from model import prepare_models
from accelerate import Accelerator
from focal_loss import FocalLoss
print("start the codes5")
...
def main(args, dict_config, config_file_path):
    ...
    dataloaders_dict = prepare_dataloaders_go(configs)
    ...
    if configs.train_settings.loss == 'crossentropy':
        ...
        criterion = torch.nn.BCEWithLogitsLoss(
            reduction='none')  # F.binary_cross_entropy_with_logits in torchdrug https://torchdrug.ai/docs/_modules/torchdrug/tasks/property_prediction.html#MultipleBinaryClassification
    ...
    tools = {
        ...
        'logging': logging,
        'num_labels': configs.encoder.num_classes  # revise by QShao Dec-7-2023
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_path", "-c", help="The location of config file", default='./config_go.yaml')
